...
{
    /// <inheritdoc />
    public class RootHelpOnEmptyCliCommandBuilder : global::DotMake.CommandLine.CliCommandBuilder
    {
        /// <inheritdoc />
        public RootHelpOnEmptyCliCommandBuilder()
        {
            DefinitionType = typeof(global::TestApp.Commands.RootHelpOnEmptyCliCommand);
        ...
        protected override global::System.CommandLine.Command DoBuild(global::DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var command = IsRoot
                ...
                (
                    Namer.GetCommandName("RootHelpOnEmptyCliCommand")
                );
            var rootCommand = command as global::System.CommandLine.RootCommand;
            command.Description = "A root cli command";
            Namer.AddShortFormAlias(command, "RootHelpOnEmptyCliCommand");
            ...
            {
                return new global::TestApp.Commands.RootHelpOnEmptyCliCommand();
            };
            bindingContext.BinderMap[DefinitionType] = (instance, parseResult) =>
            {
                var definitionInstance = (global::TestApp.Commands.RootHelpOnEmptyCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<global::TestApp.Commands.RootHelpOnEmptyCliCommand>(parseResult);
        ...
        {
            var commandBuilder = new global::TestApp.Commands.GeneratedCode.RootHelpOnEmptyCliCommandBuilder();
